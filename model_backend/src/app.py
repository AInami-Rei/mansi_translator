...
def gen_translate(model, tokenizer, text: str, src: str, trg: str, max_length: str = 200, num_beams: str = 5, repetition_penalty: float = 5.0, **kwargs) -> str:
...
class Translator:
    def __init__(self):
        # Load models
        ru_ms_model, ru_ms_tokenizer = init_model_tokenizer(service_settings.ru_ms_model_name, service_settings.default_device) 
        ms_ru_model, ms_ru_tokenizer = init_model_tokenizer(service_settings.ms_ru_model_name, service_settings.default_device) 

        self.models = {"ru-ms": ru_ms_model, "ms-ru": ms_ru_model}
        self.tokenizers = {"ru-ms": ru_ms_tokenizer, "ms-ru": ms_ru_tokenizer}
        self.maxlen = {"ru-ms": service_settings.ru_ms_model_maxlen, "ms-ru": service_settings.ms_ru_model_maxlen}
